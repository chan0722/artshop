...
<head>
    ...
    <script>
        ...
        function load_all_order(){
            ...
            xmlhttp.open("GET", "function_admin.php?op=get_all_order_list", true);
            xmlhttp.send();
        }
...
?>
<br>
<input type="number" id="search_order_bar" required placeholder="Search By Order ID">
<button id="search_product" onclick="searchOrder()">search</button>
